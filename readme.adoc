...
- Generate the Argo CD Application or Project Kubernetes CR for the Quarkus application
- Command Line interface to install / uninstall and list Argo CD Application(s)
- Integration with Quarkus Helm
- DevServices able to install ArgoCD on kubernetes cluster: kind or k3s
